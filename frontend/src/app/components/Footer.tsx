...
// Inline SVGs replace Github/Twitter/Linkedin which were removed in lucide-react v1.x
const XIcon = () => (
...
export function Footer() {
  return (
    <motion.footer
      ...
      className="relative z-10 border-t border-white/5 mt-32"
    >
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-3">AdaptAI</h3>
            <p className="text-white/60 mb-4 max-w-md">
              Personalized AI responses powered by 5 leading models. 
              Intelligence that adapts to your knowledge level.
            </p>
            <div className="flex gap-3">
              <a
                href="#"
                aria-label="X (Twitter)"
                className="w-10 h-10 rounded-lg flex items-center justify-center text-white/60 hover:text-white transition-colors"
                style={{
              ...
              <a
                href="https://github.com/Rutik-Phadtare"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/rutik-phadtare-48722a2a9"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-lg flex items-center justify-center text-white/60 hover:text-white transition-colors"
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">
            © 2026 AdaptAI. All rights reserved.
          </p>
